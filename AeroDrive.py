...
class travel:
    ...
    def __init__(self,root):
        self.root = root
        self.root.title("AeroDrive-Bennett University")
        ...
        def Kilo():
            if var2.get() == 0:
                ...
                if varl1.get() == "CampusCafe":
                    switch ={"Pari Chowk": 10,"Depot Station": 8,"Alpha-1":9,"Knowledge Park": 12}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "Knowledge Park":
                    switch ={"Pari Chowk": 4,"Depot Station": 9,"Alpha-1":5,"CampusCafe": 12}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "Alpha-1":
                    switch ={"Pari Chowk": 4,"Knowledge Park": 6,"Depot Station":6,"CampusCafe": 10}
                    Km.set(switch[varl2.get()])
                elif varl1.get() == "Pari Chowk":
                    switch ={"Alpha-1": 5,"Knowledge Park": 3,"Depot Station":7,"CampusCafe": 12}
                    Km.set(switch[varl2.get()])        
   ...
   #================================================mainframe========================================================================
        ...
        self.lblTitle=Label(Tops,font=('arial',70,'bold'),text=" AeroDrive- Bennett University ")
        self.lblTitle.grid()
    ...
    #===============================================Taxi Information==============================================================
        ...
        self.cboPickup['value']=('','CampusCafe','Knowledge Park','Alpha-1','Pari Chowk')
        self.cboPickup.current(0)
        ...
        self.cboDrop['value']=('','Knowledge Park','Alpha-1','CampusCafe','Pari Chowk')
        self.cboDrop.current(0)
